...
/* Search */
.search-container { position: relative; width: 260px; flex-shrink: 0; }
.search-input-wrap { position: relative; display: flex; align-items: center; }
.search-input { width: 100%; padding: 0 14px 0 36px; border-radius: 8px; border: none; background: rgba(255,255,255,0.12); color: white; font-size: 13px; outline: none; box-sizing: border-box; height: 38px; }
.search-input::placeholder { color: rgba(255,255,255,0.4); }
.search-input:focus { background: rgba(255,255,255,0.2); }
.search-icon { position: absolute; left: 11px; top: 50%; transform: translateY(-50%); font-size: 14px; pointer-events: none; z-index: 1; }
